...
O algoritmo utilizado nesse trabalho para calcular a CDF de um conjunto de
números em ponto flutuante é descrito em \ref{alg:cdf}
...
complicado (necessita de ser ordenado na memória externa).
